 ...
 */
export function findMatches(text: string, query: string, caseSensitive = false): SearchMatch[] {
  if (!query) return []
 ...
 */
export function highlightMatches(text: string, matches: SearchMatch[], activeIndex = -1): string {
